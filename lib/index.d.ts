...
declare module "@charitips/pdfkit/js/data" {
...
declare module "@charitips/pdfkit" {
  var doc: PDFKit.PDFDocument;
  export = doc;
}

declare module "@charitips/pdfkit/js/gradient" {
  var gradient: {
...
declare module "@charitips/pdfkit/js/pattern" {
  var pattern: {
...
declare module "@charitips/pdfkit/js/page" {
...
declare module "@charitips/pdfkit/js/reference" {
...
declare module "@charitips/pdfkit/js/structure_content" {
...
declare module "@charitips/pdfkit/js/structure_element" {
  var PDFStructureElement: PDFKit.PDFStructureElement;
  export = PDFStructureElement;
}

declare module "@charitips/pdfkit/js/mixins/annotations" {
  var PDFKitAnnotation: PDFKit.Mixins.PDFAnnotation;
  export = PDFKitAnnotation;
}

declare module "@charitips/pdfkit/js/mixins/color" {
  var PDFKitColor: PDFKit.Mixins.PDFColor;
  export = PDFKitColor;
}

declare module "@charitips/pdfkit/js/mixins/fonts" {
  var PDFKitFont: PDFKit.Mixins.PDFFont;
  export = PDFKitFont;
}

declare module "@charitips/pdfkit/js/mixins/images" {
  var PDFKitImage: PDFKit.Mixins.PDFImage;
  export = PDFKitImage;
}

declare module "@charitips/pdfkit/js/mixins/text" {
  var PDFKitText: PDFKit.Mixins.PDFText;
  export = PDFKitText;
}

declare module "@charitips/pdfkit/js/mixins/vector" {
  var PDFKitVector: PDFKit.Mixins.PDFVector;
  export = PDFKitVector;
}

declare module "@charitips/pdfkit/js/mixins/markings" {
